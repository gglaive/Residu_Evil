...
public class Game {
    ...
    private void createRooms() {
        ...
        library = new Room("in the library. It's quite big and almost too bright, but you see one of the medals thanks to that!");
        ...
        station_hall.setItem(ammo);
        library.setItem(medal);
        backyard_room.setItem(medal);
    ...
    private boolean step(Command command){
    	if(!command.getCommandWord().equals("quit")
    			&& !command.getCommandWord().equals("inventory")
    			&& !command.getCommandWord().equals("look")
    			&& !command.getCommandWord().equals("help")
    			&& !command.getCommandWord().equals("go")){
    		if(currentRoom.getZombies() != null){
    ...
    private void use(Command command) {
    	...
    	if(command.getSecondWord().equals("medal")){
    		...
    		if(!currentRoom.equals("station_hall")){
