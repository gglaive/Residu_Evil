...
public class GameEngine {
    ...
    private void createRooms() {
        ...
        // create the rooms
        // start
        outside = new Room("in the streets of Fock City. You can see the police station from here. Zombies are all around you so you should hurry", "outside.jpg");
    ...
    private void printWelcome() {
        ...
        gui.println("It's night-time and zombies are moving fast. You have to find a way out of this city");
    ...
    private void printHelp() {
        ...
        gui.println("shoot *ZombieNumber* (ex: 2 zombies, 'shoot 1' means shoot on the zombie number 1) = fire on a zombie");
        ...
        if(!currentRoom.equals(rooms.get("outside"))) {
        	if(!currentRoom.getZombies().isEmpty()){
            	...
            	if(rand.nextInt(10) >= 7) {
            		player.isAttacked();
            		gui.println("A zombie bite you while you were escaping!");
            	}
            	else {
    ...
    private void shoot (Command command){
    	if(player.getGun().getAmmo() == 0) {
    		...
    		gui.println("The zombies are coming closer! RUN!!");
    		return;
    	}
    	...
    	if(rand.nextInt(10) >= 6) {
    		...
    		if(zombie.getAggro() < 0)
    			zombie.setAggro(0);
    		gui.println("Zombie " + zombie_number + " flinched!");
    	}
    	...
    	gui.println("Zombie " + zombie_number + " has " + zombie.getHealth() + " hp left !");
    	
    	if(zombie.getHealth() == 0) {
    		gui.println("Zombie " + zombie_number + " is dead !");
